...
import 'package:restaurant/src/data/services/restaurant_test_service.dart';
...
void main() {
  test('should fetch restaurants successfully', () async {
    // Create a mock client
    final mockClient = MockClient();

    // Create an instance of RestaurantTestService
    final restaurantService = RestaurantTestService();
    ...
    final List<RestaurantMod> expectedData = jsonDataList
        .map((data) => RestaurantMod(
              id: data['id'],
              name: data['name'],
    ...
    final result = await restaurantService.getRestaurant();
